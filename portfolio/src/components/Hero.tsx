  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl w-full">
        ...
        <div ref={statusRef} id="hero-status" className="flex items-center gap-3 mb-5">
        ...
        <div className="space-y-3">
          ...
          <div className="inline-block" style={{ perspective: '800px', perspectiveOrigin: 'left center' }}>
            <h1
              ref={namePlaneRef}
              id="hero-name"
          ...
          <div ref={midgroundRef} className="space-y-3 origin-left" style={{ transformStyle: 'preserve-3d' }}>
            <p
              ref={roleRef}
              id="hero-role"
            ...
            <div ref={headlineRef} id="hero-tagline" className="pt-1.5 pb-0.5">
          ...
          <p ref={descRef} id="hero-desc" className="font-sans text-sm sm:text-base text-slate-400 max-w-[700px] leading-relaxed">
            15+ years of frontend experience, building production websites from Figma across custom WordPress themes, Gutenberg
            blocks, and Shopify Liquid storefronts.
          </p>
        </div>
        ...
        {/* 6. Action CTAs */}
        <div ref={ctaRef} id="hero-cta" className="mt-6 flex flex-wrap items-center gap-4">
          <button
